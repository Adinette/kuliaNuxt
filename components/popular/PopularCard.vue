<template>
        <div class="xl:col-span-8 lg:col-span-7 md:col-span-9 ">
            <div class="space-y-2">
            ...
            <div class="space-y-2">
                <div class="flex mt-1 items-center text-xs">
                    <span class="text-block">
                        <span class="textOne">Solo travel</span>
                        <span class="textTwo mx-1">by</span>
                        <span class="textThree">Ed M. Appleton</span>
                    </span>
                </div>
                <h2 class="text-2xl my-4 text-black font-semibold leadi">The Golden Sands Of Florida And California</h2>
                <p class="mt-4 mb-8 text-slate-600 text-sm">Non cum dignissim ac felis integer penatibus sit. Adipiscing eu tristique turpis eu. Leo orci, in blandit consequat nulla tempor. Nibh diam tincidunt nunc fusce sed. Nibh vitae, a ut rhoncus, enim tortor pellentesque viverra feugiat.</p>
            </div>
            <div class="flex flex-wrap items-center justify-between">
                <div class="flex space-x-2">
                    <span class=" text-xs mt-2 dark:text-gray-400">Aug 25, 2020</span>
                ...
                <div class="flex items-center space-x-2 text-sm dark:text-gray-400">
                    <span>share</span>
            ...
            <button type="button"
                class="flex items-center justify-center p-3 font-semibold tracki rounded-md dark:bg-orange-500 dark:text-gray-900">Read
                more</button>
